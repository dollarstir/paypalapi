                            ...
                            <div class="widget-header">                                
                                <div class="row">
                                        ...
                                        <?php  
                                            ...
                                            $getpro=mysqli_query($conn,"SELECT * FROM products WHERE id = '$id' ");
                            ...
                            <div class="widget-content widget-content-area">
                                <form class="editprod">
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <input name="name" type="text" class="form-control-rounded form-control" id="exampleFormControlInput1" placeholder="Product name" value= "<?php echo $name ;?>" >
                                    </div>

                                    <input name="id" type="hidden" class="form-control-rounded form-control" id="exampleFormControlInput1" placeholder="Course Title" value= "<?php echo $id; ?>" >
                                    <input name="oldpic" type="hidden" class="form-control-rounded form-control" id="exampleFormControlInput1" placeholder="Course Title" value= "<?php echo $pic; ?>" >
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <input name="image" type="file" class="form-control-rounded form-control" id="exampleFormControlInput1" placeholder="Iamge ">
                                    </div>

                                    <div class="form-group mb-4">
                                        <!-- <label for="exampleFormControlInput1">Quantity</label> -->
                                        <input name="price" type="number" class="form-control-rounded form-control" id="exampleFormControlInput1" placeholder="Fees for this course  "  value= "<?php echo $price ;?>">
                                    </div>
                                    ...
                                    <input type="submit" name="editbtn" class="mt-4 mb-4 btn btn-button-7 btn-rounded sub" value="Update product" style="margin-left:150px;background-color:green !important;">
