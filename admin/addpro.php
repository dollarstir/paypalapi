                            ...
                            <div class="widget-content widget-content-area">
                                <form class="subpro">
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <input name="name" type="text" class="form-control-rounded form-control" id="exampleFormControlInput1" placeholder="Product Name">
                                    </div>
                                    ...
                                    <div class="form-group mb-4">
                                        <!-- <label for="exampleFormControlInput1">Quantity</label> -->
                                        <input name="price" type="number" class="form-control-rounded form-control" id="exampleFormControlInput1" placeholder="Product Price">
                                    </div>
                ...
                <div class="col-xl-5 col-md-6 col-sm-6 col-12">
                    <ul class="list-inline mb-0 d-flex justify-content-sm-end justify-content-center mr-sm-3 ml-sm-0 mx-3">
                        <li class="list-inline-item  mr-3">
                            <p class="bottom-footer">© <?php echo date("Y");?> <a target="_blank" href="https://dollarstir.purplesofts.com/">Designed by Frederick Ennin</a></p>
                        </li>
